...
ActiveRecord::Schema.define(version: 2021_04_21_021546) do
  ...
  create_table "schedules", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["eventpost_id"], name: "index_schedules_on_eventpost_id"
    t.index ["user_id", "eventpost_id"], name: "index_schedules_on_user_id_and_eventpost_id", unique: true
  ...
  add_foreign_key "schedules", "eventposts"
